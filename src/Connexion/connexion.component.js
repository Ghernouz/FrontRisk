...
var ConnectForm = (function () {
    ...
    ConnectForm = __decorate([
        ...
        __metadata('design:paramtypes', [(typeof (_a = typeof connexion_service_1.ConnexionService !== 'undefined' && connexion_service_1.ConnexionService) === 'function' && _a) || Object, router_1.Router])
    ], ConnectForm);
    return ConnectForm;
    var _a;
}());
